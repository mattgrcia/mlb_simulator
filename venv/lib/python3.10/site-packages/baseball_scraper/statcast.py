...
def large_request(start_dt, end_dt, d1, d2, step, verbose):
    ...
    no_success_msg_flag = (
        False  # a flag for passing over the success message of requests are failing
    )
...
def postprocessing(data, team):
    ...
    if team in valid_teams:
        ...
        raise ValueError(
            "Error: invalid team abbreviation. Valid team names are: {}".format(
                valid_teams
            )
        )
...
def statcast(start_dt=None, end_dt=None, team=None, verbose=True):
    ...
    if start_dt and end_dt:
        ...
        if days_in_query <= small_query_threshold:
            ...
            data = large_request(
                start_dt, end_dt, d1, d2, step=small_query_threshold, verbose=verbose
            )
